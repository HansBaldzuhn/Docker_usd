...
getFileWithFallback maya-usd-master.zip https://github.com/Autodesk/maya-usd/archive/master.zip
getFileWithFallback ninja-v1.9.0.tar.gz https://github.com/ninja-build/ninja/archive/v1.9.0.tar.gz